...
export class AppComponent {
  ...
  masterKegList: Keg[] = [
    ...
    new Keg("Dos Equis", "Cerveceria Cuauhtemoc Moctezuma", 4, 4.5, 10, "American Lager", "http://www.almuerzodenegocios.com/wp-content/uploads/2013/08/Dos-Equis-Logo-Web.png", this.blurbFiller)
  ];
